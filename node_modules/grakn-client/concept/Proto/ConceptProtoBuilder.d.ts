/// <amd-module name="grakn-client/concept/proto/ConceptProtoBuilder" />
...
export declare namespace ConceptProtoBuilder {
    ...
    function valueType(valueType: AttributeType.ValueType): ConceptProto.AttributeType.VALUE_TYPE;

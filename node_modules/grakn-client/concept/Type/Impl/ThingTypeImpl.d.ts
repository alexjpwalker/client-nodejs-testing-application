...
import { TypeImpl, RemoteTypeImpl, ThingType, RemoteThingType, AttributeType, RoleType, Grakn, Stream, ThingImpl, RoleTypeImpl, AttributeTypeImpl } from "../../../dependencies_internal";
...
export declare class RemoteThingTypeImpl extends RemoteTypeImpl implements RemoteThingType {
    ...
    setOwns(attributeType: AttributeType, isKey: boolean, overriddenType: AttributeType): Promise<void>;
